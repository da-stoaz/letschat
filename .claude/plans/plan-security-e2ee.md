...
The companion `plan-efficiency-cache.md` (local cache, incremental sync, search) depends on this plan and is only sound because decryption here is repeatable.
...
- The **user account** is unchanged — auth-service, username/password, JWT.
