...
namespace CoreApi.Data.Migrations
{
    ...
    [Migration("20260519181535_SystemConfigAndAuditLog")]
    partial class SystemConfigAndAuditLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreApi.Data.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("SpacetimeIdentity")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");

                    b.Property<string>("SpacetimeIdentityNorm")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");

                    b.Property<string>("SpacetimeToken")
                        .IsRequired()
                        .HasMaxLength(4096)
                    ...
                    b.HasIndex("SpacetimeIdentityNorm")
                        .IsUnique()
            ...
            modelBuilder.Entity("CoreApi.Data.AuditLogEntry", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CoreApi.Data.UploadQuota", b =>
                {
                    b.Property<string>("Username")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.HasKey("Username", "QuotaDate");

                    b.ToTable("UploadQuotas");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CoreApi.Data.ApplicationUser", null)
                        .WithMany()
